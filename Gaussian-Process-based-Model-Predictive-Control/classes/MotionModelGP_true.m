...
classdef MotionModelGP_true < MotionModelGP
    %--------------------------------------------------------------------------
    ...
    properties(Constant)
        ...
        nz = 5   % dimension of z(t) = size(Bz_x,1) + size(Bz_u,1) = 3 + 2
    ...
    methods
        function obj = MotionModelGP_true(d,sigmaw)
            %------------------------------------------------------------------
        ...
        function [F_y_f, F_y_r] = getTireForces(obj, x, u)
            %------------------------------------------------------------------
            %   Extract lateral tire forces from the Pacejka tire model
            %   out:
            ...
            % Pacejka tire model forces (in wheel coordinates)
