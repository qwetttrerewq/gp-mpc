    ...
    methods
        ...
        function cost = costfun(obj, vars, t0, r, mu_x0)
            ...
            for iN=1:obj.N      % i=0:N-1
                ...
                % update current time
                % t = t + iN * obj.dt;  %BUG: incorrect time accumulation (exponential growth)
                t = t + obj.dt;  % FIXED: increment by dt at each step
            end
        ...
        function [cineq,ceq] = nonlcon(obj, vars, t0, mu_x0)
            ...
            for iN=1:obj.N
                ...
                % t = t + iN * obj.dt;  % BUG: incorrect time accumulation (exponential growth)
                t = t + obj.dt;  %BUG: increment by dt at each step
            end
