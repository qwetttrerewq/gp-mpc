...
% save('simresults/scenario1_results.mat', 'out', 'track');
fprintf('Results saved to: simresults/scenario1_results.mat\n');
fprintf('Run analyze_scenario1.m to visualize tracking performance.\n\n');
